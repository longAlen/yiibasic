...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        ...
        <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">神通科技 - 后台管理</a>
        ...
        <ul class="nav pull-right">
            ...
            <li class="settings hidden-phone">
                <a href="personal-info.html" role="button" title="设置">
                    <i class="icon-cog"></i>
                </a>
            </li>
            ...
            <li class="settings hidden-phone">
                ...
                <a href="<?php echo \yii\helpers\Url::to(['public/logout']);?>" role="button" title="退出">
...
<div id="sidebar-nav">
    <ul id="dashboard-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="<?php echo Yii::$app->urlManager->createUrl(['admin/category/index'])?>">分类列表</a></li>
                <li><?php echo \yii\helpers\Html::a('添加分类',['category/add']);?></li>
            </ul>
        </li>
        <li>
            <a class="dropdown-toggle" href="#">
            ...
            <ul class="submenu">
                <li><a href="<?php echo \yii\helpers\Url::to(['product/index']);?>">商品列表</a></li>
                <li>
                    <?php echo \yii\bootstrap\Html::a('添加商品',['product/add']);?>
                </li>
            </ul>
        </li>
        <li>
        ...
        <li>
            ...
            <ul class="submenu">
                <li><a href="/index.php?r=admin%2Forder%2Flist">广告位列表</a></li>
                <li><a href="/index.php?r=admin%2Forder%2Flist">广告列表</a></li>
            </ul>
        </li>
...
<script type="text/javascript">
    ...
    //添加规格参数
    $("#spc-add").click(function () {
        var spc = $(".spc-tbody").find('tr.spc-tr').first().clone();
        $(".spc-tbody").append(spc);
        $(".spc-remove").bind('click',function () {
            var str_num = $(".spc-tbody").find('tr.spc-tr').length;
            if (Number(str_num)>1){
...
<script type="text/javascript">
       function Del(target,targetId,token){
            layer.confirm('确定删除吗?删除后不可恢复！', {
                btn: ['确定','取消'] //按钮
            }, function(){
                $.post(target,{id:targetId,_csrf:token},function(res){
                    if (res.status==1){
       ...
       function  UpperOrSlower(target,targetId,token) {
