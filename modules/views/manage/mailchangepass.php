...
<!--            --><?php //echo $form->field($model,'adminuser')->textInput(['class'=>'span12','placeholder'=>'用户账号','disabled'=>true])?>
            <?php echo $form->field($model,'newPassword')->passwordInput(['class'=>'span12','placeholder'=>'新密码']);?>

            <?php echo $form->field($model,'newPassword_2')->passwordInput(['class'=>'span12','placeholder'=>'确认密码'])?>
            <a href="<?php echo \yii\helpers\Url::to(['public/login'])?>" class="forgot">返回登录</a>
<!--            --><?php //echo  Html::a('返回登录',['public/login'],['class'=>'forget']);?>
